package com.github.kory33.experimental.proof.set
...
import com.github.kory33.experimental.proof.set.logic.SpecializedPredicateSystem._
...
object Universal {
  ...
  implicit def selfInclusion[A]: A ⊂ A = {
    byContradiction { assumption: ∃[[z] => ￢[(z ∈ A) => (z ∈ A)]] =>
      type Z = assumption.S
